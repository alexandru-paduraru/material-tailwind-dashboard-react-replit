    ...
    <section className="m-8 flex">
      ...
      <div className="w-full lg:w-3/5 flex flex-col items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4 text-gray-800">Join Us Today</h2>
          <p className="text-lg font-normal text-gray-600">Enter your email and password to register.</p>
        </div>
        <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          ...
          <p className="block mt-4 font-sans text-base antialiased font-normal leading-relaxed text-center text-gray-700">
            ...
            <Link to="/auth/sign-in" className="font-medium text-gray-900 ml-1">Sign in</Link>
          </p>
        </form>
      </div>
    </section>
